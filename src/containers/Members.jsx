            ...
            <div className="members-container" id="members">
                <div>
                    ...
                    <div className='m-list'>
                        <Member img="Goktug.png" n="Goktuğ Bender" position="VP Sponsorship" field="U3 Psychology"/>
                    ...
                    <div className='m-list'>
                        ...
                        <Member img="Aichelle.png" n="Aichelle" position="Logistics" field="U1 Computer Science"/>
                        <Member img="Debbie.png" n="Debbie Fitopoulos" position="Logistics" field="U1 Interfaculty BA&SC"/>
                    ...
                    <div className='m-list'>
                        ...
                        <Member img="Sabrina.png" n="Sabrina Du" position="Machine Learning and Sponsorship Liaison" field="U1 Neuroscience"/>
                    </div>
                    <div className='m-committees'><span>Web Development</span></div> 
                    <div className='m-list'>
                        <Member img="Efe.png" n="Efe Ertugrul" position="VP Web Development" field="U3 CompSci/Stats"/>
                    </div>
                    <div className='m-committees'><span>Advising</span></div>
                    <div className='m-list'>
                        <Member img="AOP.png" n="Alexis Nolin-Lapalme, Ozhan Deghani, Pascal Spiegler" position="Advising" field="Former Presidents"/>
                    </div>
                </div>
            </div>
        </div>
